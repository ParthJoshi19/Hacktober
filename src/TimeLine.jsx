...
const TimeLine = () => {
  ...
  return (
    <div className="timeline max-w-[1200px] my-[100px] mx-auto relative after:content-[''] after:absolute after:w-[2px] after:h-[100%] after:bg-[#65ff23] after:top-0 after:transform after:translate-x-[-50%] after:z-[-1]">
      {arr.map((item, index) => (
        <div
